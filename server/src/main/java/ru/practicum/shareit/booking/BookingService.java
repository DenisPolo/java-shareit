...
public interface BookingService {
    List<BookingDto> findBookingsForUser(long userId, String status, int from, int size);

    List<BookingDto> findBookingsForOwner(long ownerId, String status, int from, int size);
